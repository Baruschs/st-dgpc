...
imageUrl: "${process.env.PUBLIC_URL}/data/images/trab\_equipo.jpg",
},
...
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/terr\_yaqui.pmtiles",
...
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/Topolobampo.pmtiles",
...
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/mun\_Helax.pmtiles",
...
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/comunidades\_inpi.pmtiles",
...
layers: [{
id: 'ent-Mex-Qro',
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/ent\_Tren\_Mex-Qro.pmtiles",
sourceLayer: "ent\_Tren\_MexQro\_tile",
layerType: "polygon",
},
{
id: 'trazomeqro',
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/trazo\_Mex-Qro.pmtiles",
...
layers: [{
id: 'ent-AIFA-Pach',
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/ent\_AIFA-Pachuca.pmtiles",
sourceLayer: "ent\_AIFAPachuca\_tile",
layerType: "polygon",
},
{
id: 'trazoaifapach', // Cambiado ID para que sea único
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/trazo\_AIFA-Pachuca.pmtiles",
...
layers: [{
id: 'ent_ecp', 
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/ent\_ecp.pmtiles",
...
layers: [{
id: 'ent_ecp', 
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/cdjuarez.pmtiles",
...
layers: [{
id: 'Celaya', 
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/Celaya.pmtiles",
...
layers: [{
id: 'gam', 
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/gam.pmtiles",
...
layers: [{
id: 'tlapa', 
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/tlapa-gro.pmtiles",
