...
imageUrl: "${process.env.PUBLIC_URL}/data/images/trab_equipo.jpg",
},
...
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/terr_yaqui.pmtiles",
...
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/mun_Helax.pmtiles",
...
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/comunidades_inpi.pmtiles",
...
layers: [{
id: 'ent-Mex-Qro',
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/ent_Tren_Mex-Qro.pmtiles",
sourceLayer: "ent_Tren_MexQro_tile",
layerType: "polygon",
},
{
id: 'trazomeqro',
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/trazo_Mex-Qro.pmtiles",
...
layers: [{
id: 'ent-AIFA-Pach',
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/ent_AIFA-Pachuca.pmtiles",
sourceLayer: "ent_AIFAPachuca_tile",
layerType: "polygon",
},
{
id: 'trazoaifapach', // Cambiado ID para que sea único
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/trazo_AIFA-Pachuca.pmtiles",
...
layers: [{
id: 'ent_ecp', 
pmtileUrl: "pmtiles://${process.env.PUBLIC_URL}/data/ent_ecp.pmtiles",
